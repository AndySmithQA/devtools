...
const ExpensiveComponent = ({ value, onChange }: { value: number; onChange: () => void }) => {
...
const ExpensiveComponentMemo = memo(({ value, onChange }: { value: number; onChange: () => void }) => {
...
const ChildComponent = ({ title, data }: { title: string; data: any }) => {
