...
function Lab4BreakpointPractice() {
  ...
  // Helper function - practice "Step Into"
  const applyDiscount = (expense: number, category: string): number => {
  ...
  const processTransaction = (transaction: Transaction): number => {
  ...
  const handleCategoryAverage = (category: string) => {
